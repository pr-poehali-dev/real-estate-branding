...
const INTERIOR_IMG = "https://cdn.poehali.dev/projects/190f87c1-2bd1-4c13-b5a9-eb3a77869a47/files/18c4ab55-d0a7-4559-8766-8097a4295f10.jpg";
...
export default function Index() {
  ...
  return (
    <div className="min-h-screen font-montserrat" style={{ background: "var(--marble-bg)" }}>
      ...
      <section id="top" className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={INTERIOR_IMG} alt="Екатеринбург" className="w-full h-full object-cover object-center" />
          <div className="absolute inset-0" style={{ background: "linear-gradient(105deg, rgba(255,253,248,0.97) 0%, rgba(253,245,220,0.93) 35%, rgba(255,253,248,0.75) 60%, rgba(255,253,248,0.30) 100%)" }} />
          <div className="absolute inset-0 marble-overlay" />
        </div>

        <div className="absolute right-[-6%] top-[-6%] w-[480px] h-[480px] rounded-full opacity-[0.07] spin-slow"
          style={{ background: "conic-gradient(from 0deg, #c8960c, #f5d98a, #8a6005, #c8960c)" }} />
      ...
      <section id="about" className="py-20 md:py-28"
        style={{ background: "linear-gradient(180deg, var(--cream) 0%, var(--marble-light) 100%)" }}>
      ...
      {/* ── SERVICES ───────────────────────────────────────── */}
      <section id="services" className="py-20 md:py-28 marble-overlay"
        style={{ background: "linear-gradient(135deg, var(--marble-mid) 0%, var(--marble-light) 100%)" }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.map((s, i) => (
              <div key={s.title} ref={(el) => addReveal(el, 10 + i)} className="reveal card-hover rounded-2xl p-6 md:p-8 cursor-pointer"
                style={{ background: "rgba(255,253,248,0.95)", border: "1px solid rgba(200,150,12,0.18)", boxShadow: "0 6px 24px rgba(200,150,12,0.1)" }}>
      ...
      <section id="quiz" className="py-20 md:py-28"
        style={{ background: "linear-gradient(135deg, #1a0f00 0%, #2a1800 50%, #1a0f00 100%)" }}>
      ...
      {/* ── ADVANTAGES ─────────────────────────────────────── */}
      <section id="advantages" className="py-20 md:py-28" style={{ background: "var(--marble-bg)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
      ...
      {/* ── REVIEWS ────────────────────────────────────────── */}
      <section id="reviews" className="py-20 md:py-28 marble-overlay"
        style={{ background: "linear-gradient(135deg, var(--marble-light) 0%, var(--marble-mid) 100%)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {REVIEWS.map((r, i) => (
              <div key={r.name} ref={(el) => addReveal(el, 55 + i)} className="reveal card-hover rounded-2xl p-6"
                style={{ background: "rgba(255,253,248,0.98)", border: "1px solid rgba(200,150,12,0.15)", boxShadow: "0 8px 28px rgba(200,150,12,0.12)" }}>
      ...
      <section className="py-16"
        style={{ background: "linear-gradient(135deg, #b8820a 0%, #daa520 40%, #e8b830 60%, #c8960c 100%)" }}>
      ...
      {/* ── CONTACTS ───────────────────────────────────────── */}
      <section id="contacts" className="py-20 md:py-28" style={{ background: "var(--cream)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-8 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div ref={(el) => addReveal(el, 71)} className="reveal">
            <div className="rounded-2xl p-6 md:p-8"
              style={{ background: "var(--marble-bg)", border: "1px solid rgba(200,150,12,0.22)", boxShadow: "0 12px 40px rgba(200,150,12,0.14)" }}>
      ...
      {/* ── FOOTER ─────────────────────────────────────────── */}
      <footer className="py-10" style={{ background: "linear-gradient(135deg, #120b00 0%, #1e1200 100%)", borderTop: "2px solid rgba(200,150,12,0.3)" }}>
